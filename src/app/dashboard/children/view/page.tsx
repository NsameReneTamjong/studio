      ...
      <div className="relative z-10 space-y-12">
        ...
        <div className="text-center space-y-12 py-10">
          ...
          <div className="max-w-2xl mx-auto leading-relaxed text-lg md:text-xl font-medium text-gray-700 italic px-10">
            For demonstrating exceptional academic commitment during the <span className="font-black text-[#264D73]">{termNumber}</span> pedagogical cycle, and achieving a verified annual average of <span className="font-black text-[#264D73] underline decoration-[#FCD116] decoration-4 underline-offset-8">{student?.annualAvg || "15.00"} / 20</span>.
          </div>
