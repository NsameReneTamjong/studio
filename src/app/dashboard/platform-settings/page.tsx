...
export default function PlatformSettingsPage() {
  const { user, platformSettings, updatePlatformSettings, publicEvents, addPublicEvent, deletePublicEvent } = useAuth();
    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      ...
      <Tabs defaultValue={isDesigner ? "marketing" : "branding"} className="w-full">
        <TabsList className={cn(
          ...
          isDesigner ? "grid-cols-1 md:w-[300px]" : "grid-cols-4 md:w-[900px]"
        )}>
          {!isDesigner && (
            <>
