...
const MOCK_STUDENTS = [
  { id: "GBHS26S001", uid: "S1", name: "Alice Thompson", email: "alice.t@school.edu", phone: "+237 600 11 22 33", whatsapp: "+237 600 11 22 33", class: "2nde / Form 5", section: "Anglophone Section", isLicensePaid: true, status: "active", avatar: "https://picsum.photos/seed/s1/100/100", annualAvg: 16.45, subjects: ["Advanced Physics", "Mathematics"] },
  { id: "GBHS26S002", uid: "S2", name: "Bob Richards", email: "bob.r@school.edu", phone: "+237 600 44 55 66", whatsapp: "+237 600 44 55 66", class: "Terminale / Upper Sixth", section: "Anglophone Section", isLicensePaid: true, status: "active", avatar: "https://picsum.photos/seed/s2/100/100", annualAvg: 14.20, subjects: ["Mathematics", "History"] },
  { id: "GBHS26S003", uid: "S3", name: "Charlie Davis", email: "charlie.d@school.edu", phone: "+237 600 77 88 99", whatsapp: "+237 600 77 88 99", class: "1ère / Lower Sixth", section: "Francophone Section", isLicensePaid: false, status: "active", avatar: "https://picsum.photos/seed/s3/100/100", annualAvg: 9.15, subjects: ["General Chemistry"] },
  { id: "GBHS26S004", uid: "S4", name: "Diana Prince", email: "diana.p@school.edu", phone: "+237 600 00 11 22", whatsapp: "+237 600 00 11 22", class: "Terminale / Upper Sixth", section: "Technical Section", isLicensePaid: true, status: "active", avatar: "https://picsum.photos/seed/s4/100/100", annualAvg: 17.10, subjects: ["Advanced Physics"] },
  { id: "GBHS25S099", uid: "S5", name: "Ex-Student John", email: "john.ex@mail.com", class: "Terminale / Upper Sixth", section: "Anglophone Section", isLicensePaid: true, status: "graduated", avatar: "https://picsum.photos/seed/ex1/100/100", annualAvg: 12.00, subjects: ["History"] },
];
...
export default function StudentsPage() {
  ...
  const handleFinalizeAdmission = () => {
    ...
    setTimeout(() => {
      ...
      const created = { ...newStudent, id, uid: Math.random().toString(), status: "active" as any, avatar: `https://picsum.photos/seed/${id}/200/200`, annualAvg: 0, subjects: [] };
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <Tabs defaultValue="registry" className="w-full">
        <TabsList className={cn("grid w-full mb-8 bg-white shadow-sm border h-auto p-1.5 rounded-3xl", isAdmin ? "grid-cols-2 md:w-[500px]" : "grid-cols-1 md:w-[300px]")}>
        ...
        <TabsContent value="registry" className="animate-in fade-in slide-in-from-bottom-2 mt-0 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 bg-white p-4 rounded-3xl border shadow-sm items-end">
